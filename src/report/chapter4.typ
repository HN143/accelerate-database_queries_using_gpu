...
*Nhận xét:*
Dựa trên biểu đồ, DuckDB cho thấy hiệu năng vượt trội trong phần lớn các truy vấn TPC-H 1GB so với HeavyDB. Các truy vấn như Q01, Q02, Q03, Q04, Q06, Q08, Q10, Q12, Q17, Q18, Q20, Q22 có thời gian thực thi của HeavyDB cao hơn từ 2 đến 10 lần so với DuckDB. Đáng chú ý, truy vấn Q16 là một ngoại lệ tiêu biểu khi thời gian thực thi của HeavyDB vượt quá DuckDB hơn 10 lần, phản ánh sự không hiệu quả rõ rệt trong việc xử lý loại truy vấn này trên GPU. Trong khi đó, chỉ có một số ít truy vấn như Q05, Q07, Q13 và Q19 cho thấy thời gian thực thi giữa hai hệ thống là tương đương, hoặc HeavyDB nhỉnh hơn đôi chút đối với Q09 (khoảng 10–20%). Nhìn chung, DuckDB không chỉ có hiệu suất tốt hơn trên phần lớn các truy vấn mà còn cho thấy sự ổn định cao hơn trong toàn bộ tập thử nghiệm.
