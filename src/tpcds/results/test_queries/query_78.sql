--
-- Câu query so sánh số lượng, chi phí và giá bán giữa kênh cửa hàng với hai kênh khác (web và catalog)
-- Chỉ lấy những giao dịch:
-- - Không có đơn trả hàng
-- - Thực hiện trong năm 2000
-- - Có bán qua ít nhất 1 kênh khác ngoài cửa hàng
-- Kết quả được sắp xếp theo năm bán, mã sản phẩm, mã khách hàng, số lượng, chi phí và giá bán
