/*
Mô tả: Query này so sánh sự tăng trưởng doanh số bán hàng giữa kênh web và kênh cửa hàng theo quý.
...
Điều kiện:
- Năm 2000
- Phân tích theo quý 1, 2, 3
- So sánh tốc độ tăng trưởng giữa các quý của 2 kênh
*/
with
	ss as (
		select
