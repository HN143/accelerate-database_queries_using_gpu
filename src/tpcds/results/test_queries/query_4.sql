-- Query Description:
-- Truy vấn này tìm kiếm khách hàng có mức tăng trưởng doanh số mua hàng qua catalog cao hơn các kênh khác.
-- Chi tiết:
-- 1. Tính tổng doanh số của mỗi khách hàng từ 3 kênh:
--    - Cửa hàng (store)
--    - Catalog
--    - Web
-- 2. So sánh tỷ lệ tăng trưởng giữa năm 2001 và 2002
-- 3. Chọn ra những khách hàng có:
--    - Tỷ lệ tăng trưởng catalog > tỷ lệ tăng trưởng cửa hàng
--    - Tỷ lệ tăng trưởng catalog > tỷ lệ tăng trưởng web
-- 4. Sắp xếp theo ID, tên, họ và email của khách hàng
-- 5. Giới hạn 100 kết quả
-- Bảng sử dụng: customer, store_sales, catalog_sales, web_sales, date_dim
with
	year_total as (
		select
