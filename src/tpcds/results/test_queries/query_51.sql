-- Mô tả: Truy vấn này so sánh doanh số bán hàng tích lũy giữa kênh web và cửa hàng theo từng mặt hàng và ngày.
-- Chỉ hiển thị những mặt hàng có doanh số web cao hơn doanh số cửa hàng.
-- Dữ liệu được lấy trong khoảng 12 tháng từ tháng_seq = 1212.
WITH
	web_v1 as (
		select
			ws_item_sk item_sk,
