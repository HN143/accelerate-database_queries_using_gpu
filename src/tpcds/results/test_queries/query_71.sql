-- Query 71: Phân tích doanh thu theo thương hiệu và thời gian
--
-- Mô tả:
-- Truy vấn này thống kê doanh thu bán hàng với các thông tin:
-- - ID và tên thương hiệu
-- - Giờ và phút bán hàng
...
-- - Tháng 12 năm 2000
-- - Quản lý có ID là 1
-- - Thời điểm bữa ăn là 'breakfast' hoặc 'dinner'
select
	i_brand_id brand_id,
	i_brand brand,
	t_hour,
