/*
Query này thực hiện:
- Phân tích chi tiết về mua bán và trả hàng qua catalog
- Lọc sản phẩm theo các tiêu chí:
+ Màu sắc: maroon, burnished, dim, steel, navajo, chocolate
+ Giá hiện tại trong khoảng 35-45
- So sánh thông tin khách hàng giữa lúc mua và hiện tại:
+ Chỉ lấy các trường hợp tình trạng hôn nhân đã thay đổi
- Phân tích chi tiết theo:
+ Thông tin sản phẩm
+ Địa chỉ thanh toán và giao hàng
+ Các năm liên quan (syear, fsyear, s2year)
