/*
Query này thực hiện:
- Phân tích doanh số bán hàng theo kho (warehouse) cho cả web_sales và catalog_sales
- Chỉ xét các đơn hàng được vận chuyển bởi DIAMOND hoặc AIRBORNE
- Dữ liệu được lấy trong năm 2002
- Thời gian xử lý đơn hàng trong khoảng từ 49530 đến 49530+28800
- Tính toán các chỉ số theo từng tháng:
+ Doanh số bán hàng
+ Doanh số trên mỗi foot vuông diện tích kho
+ Doanh thu thuần
- Kết quả được nhóm theo:
+ Tên kho
+ Diện tích kho
+ Địa điểm (thành phố, quận, bang, quốc gia)
+ Hãng vận chuyển
+ Năm
*/
select
