-- Mô tả: Câu query này tính tổng doanh số và số lượng bán hàng của các mặt hàng
-- từ bảng store_sales, catalog_sales và web_sales.
-- Điều kiện lọc bao gồm các mặt hàng có trong bảng cross_items,
-- năm bán hàng là 2000, tháng bán hàng là tháng 11.
-- Kết quả được nhóm theo kênh bán hàng, mã thương hiệu, mã lớp và mã danh mục,
-- và giới hạn 100 dòng.
with
	cross_items as (
		select
