...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-06-19' as date) - interval 30 days)
...
and d_date between '2001-01-28' and 
        (cast('2001-01-28' as date) + interval 90 days)
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-03-15' as date) -  interval 30 days)
                and (cast ('1999-03-15' as date) + interval 30 days) 
 group by
    w_state,i_item_id
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-27' as date) 
                  and (cast('2002-08-27' as date) + interval 30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
and d_date between '2001-02-10' and 
        (cast('2001-02-10' as date) + interval 90 days)
